...
<script type="text/javascript">
	function submitData(){
		...
		$("#fm").form("submit",{
			...
			success:function(result){  //yes  或者  no
				if(result=="yes"){ //登录成功
...
<div class="easyui-window" title="tms登录" data-options="modal:true,closable:false,collapsible:false,minimizable:false,maximizable:false" style="width: 400px;height: 280px;padding: 10px">
